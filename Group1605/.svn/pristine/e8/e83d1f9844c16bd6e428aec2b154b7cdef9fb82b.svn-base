        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_DATA_GOT:
                    ...
                    dealJson(json);
//                    Log.e(TAG, "handleMessage:视图="+view );
//                    if (view != null) {
//                        dealJson(json);
//                    } else {
...
//        Log.e(TAG, "onCreate: sharedPreferences=" + sharedPreferences);
        ...
        isCacheData = ("".equals(json));//是否有本地缓存
...
//        final String keyword = tvLocation.getText().toString();
    ...
    private void dealJson(String json) {
        ...
        if (attractionsBean != null && attractionsBean.getShowapi_res_body().getPagebean() != null && attractionsBean.getShowapi_res_body().getPagebean().getContentlist() != null) {
            ...
            data.addAll(previousSize, attractionsBean.getShowapi_res_body().getPagebean().getContentlist());


            if (searchResultAdapter == null) {
                searchResultAdapter = new SearchResultAdapter(getContext(), data);
...
//            Toast.makeText(MyApp.context, "出了点小问题，稍等一下哈...", Toast.LENGTH_SHORT).show();
            pb.setVisibility(View.GONE);
        }
