...
public class SearchResultAdapter extends BaseAdapter {
    ...
    public SearchResultAdapter(Context context, List<AttractionsBean.ShowapiResBodyBean.PagebeanBean.ContentlistBean> data) {
        this.context = context;
        this.data = data;
        Log.e(TAG, "SearchResultAdapter: context="+context );
